...
{
    public class FxLoginCajero
    {
        public readonly IDatabaseService _serviceDatabase;


        public FxLoginCajero(IDatabaseService serviceDatabase)
        {
        ...
        [FunctionName("FxLoginCajero")]
        [FixedDelayRetry(3, "00:00:05")]
        [OpenApiOperation(operationId: "ListLoginCajero", tags: new[] { "ListLoginCajero" }, Description = "Login de Cajero", Summary = "Login de Cajero")]
        ...
        public async Task<IActionResult> ListLoginCajero(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "V1.0/LoginCajero/{idUsuario}/{idContraseña}/{idRol}")] HttpRequest req, string idUsuario, string idContraseña, string idRol)
        {
            try
            {
